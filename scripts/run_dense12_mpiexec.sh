#!/bin/bash
# Dense DP=12 Benchmark launch script
...
export PYTHONPATH=$PYTHONPATH:$(pwd)/..:$(pwd)/../..:$AURORA_INF:$SPACK_TORCH:$SPACK_IPEX:$LOCAL_TRITON:$PYTHONPATH:$SYSTEM_SITES
...
export TORCH_EXTENSIONS_DIR="./torch_extensions_dense"
...
$MPIEXEC -n 12 -ppn 12 $PYTHON_EXE -u $BASE_DIR/mpi_train_wrapper.py \
    --job.config_file $BASE_DIR/torchtitan/models/llama4/train_configs/llama4_dense12_xpu.toml \
    --training.steps=20
