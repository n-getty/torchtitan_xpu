...
# Note: Aurora nodes typically have 6 GPUs x 2 tiles = 12 devices.
$MPIEXEC -n 12 -ppn 12 $PYTHON_EXE -u $BASE_DIR/mpi_train_wrapper.py \
    --job.config_file $BASE_DIR/torchtitan/models/llama4/train_configs/llama4_ep12_triton_xpu.toml \
    --training.steps=20
