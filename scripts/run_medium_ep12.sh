#!/bin/bash
# Medium Model EP=12 Benchmark Launch Script
# Uses mediummodel_12_rank (dim=2304, 24 layers, 12 experts)
...
echo "Launching Medium Model EP=12 Benchmark on 12 XPU ranks..."
$MPIEXEC -n 12 -ppn 12 $PYTHON_EXE -u $BASE_DIR/mpi_train_wrapper.py \
    --job.config_file $BASE_DIR/torchtitan/models/llama4/train_configs/llama4_medium_ep12_xpu.toml \
    --training.steps=20
