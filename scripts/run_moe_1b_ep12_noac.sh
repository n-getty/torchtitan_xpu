#!/bin/bash
# MoE 1B EP=12 Benchmark (Native EP, No AC)
set -e
...
echo "=== MoE 1B EP=12 Benchmark (Compiled, No AC, Native EP) ==="
echo "PYTHONPATH=$PYTHONPATH"
echo "Starting at: $(date)"
echo ""

mpiexec -n 12 -ppn 12 --envall python -u torchtitan/mpi_train_wrapper.py \
    --job.config_file torchtitan/torchtitan/models/llama4/train_configs/llama4_1b_moe_ep12_xpu_compile_noac.toml
